...
3. Is nightly mode AND plugin is in DPDY AND metadata is OCI?
   Yes → use {{inherit}} tag:  oci://{registry}/plugin:{{inherit}}
         (registry from NIGHTLY_DPDY_OCI_REGISTRY_MAP > NIGHTLY_DPDY_OCI_REGISTRY > default registry.access.redhat.com/rhdh)
   No  ↓
...
|---|----------|----------|---------------------------|----------------------|---------------------|-----------------|
| 1 | DPDY OCI plugin | Yes | `oci://ghcr.io/.../plugin-tekton:bs_1.49.4__3.33.3!alias` | `oci://ghcr.io/.../plugin-tekton:old_tag!alias` | `oci://registry.access.redhat.com/rhdh/plugin-tekton:{{inherit}}` (default RHEC registry) | **Skipped** (RHDH provides defaults) |
...
| 6 | DPDY OCI (wrapper in config) | Yes | `oci://ghcr.io/.../plugin-tekton:bs_1.49.4__3.33.3!alias` | `./dynamic-plugins/dist/plugin-tekton` | `oci://registry.access.redhat.com/rhdh/plugin-tekton:{{inherit}}` | **Skipped** |
...
| 10 | DPDY plugin (metadata on RHEC) | Yes | `oci://registry.access.redhat.com/rhdh/plugin-orch@sha256:f40d` | `oci://ghcr.io/.../plugin-orch:some_tag` | `oci://registry.access.redhat.com/rhdh/plugin-orch:{{inherit}}` (default RHEC) | **Skipped** |
| 11 | DPDY plugin (metadata on ghcr.io) | Yes | `oci://ghcr.io/.../plugin-orch:bs_1.49.4__5.7.10!alias` | `oci://ghcr.io/.../plugin-orch:old` | `oci://registry.access.redhat.com/rhdh/plugin-orch:{{inherit}}` (default RHEC, not metadata) | **Skipped** |
